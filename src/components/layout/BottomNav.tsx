...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 h-16 bg-white border-t border-border flex items-center justify-around px-2 shadow-lg lg:hidden pb-safe">
      {navItems.map((item) => {
