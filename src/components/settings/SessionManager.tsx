      ...
      <GlassCard className="gradient-border p-5 space-y-4">
        ...
        >
          <div className="sm:col-span-2">
            ...
            >
              {DAYS.map((day, idx) => (
                <option key={idx} value={idx} className="bg-[#121214]">
                  {day}
                </option>
              ))}
            </select>
          ...
          <input
            ...
            className="glass-input w-full sm:col-span-2 rounded-xl px-4 py-2 text-sm"
            min={1}
            required
          />
          <button
            ...
            className="sm:col-span-2 py-2 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl text-xs font-bold transition flex items-center justify-center gap-1 shadow-glow"
          >
