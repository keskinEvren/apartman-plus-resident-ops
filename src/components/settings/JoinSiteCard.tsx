    ...
    <GlassCard className="p-6 space-y-4">
      ...
      <form onSubmit={handleSubmit} className="flex gap-3 pt-2">
        <input
          ...
          className="input-field flex-1 rounded-xl px-4 py-2.5 text-sm uppercase text-center font-bold tracking-wider"
          required
        />
        <button
          type="submit"
          disabled={claimMutation.isPending}
          className="px-5 py-2.5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 shrink-0 disabled:opacity-50"
        >
